...
def main():
    ...
    parser = argparse.ArgumentParser(prog='Deep Single Image calibration', description='Inference code to show the predicted camera parameters')
    parser.add_argument('--img_dir', default='images/')
    parser.add_argument('--weights_dir', default='weights/')
    parser.add_argument('--viz_mode', default='grid', help='Grid stores images in grids. Single saves single images.')

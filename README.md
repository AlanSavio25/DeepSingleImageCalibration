...
3. [Network 3](https://drive.google.com/drive/folders/1p5j6PRgmMseo3AolIOJnsPmZFFCpyHvF) is trained to estimate 4 parameters: same as above, but trained on images with varying aspect ratios (1 and 2 are trained on square images only).
